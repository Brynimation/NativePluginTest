...
bool D3D11RendererAPI::InitialiseShaders() 
{
    ...
    device->CreateInputLayout(inputElementDesc, ARRAYSIZE(inputElementDesc), vertexShaderBlob, sizeof(vsBlob), &inputLayout);
}
